    ...
    return (
        <View className="index">
            ...
            <View className="content">
                        ...
                        return (
                            <View className="item">
                                ...
                                <View className="item-body" onClick={handleGoEdit.bind(this, index)} style={contentStyle}>
                                    <CropImg width={SELECT_WIDTH} height={SELECT_WIDTH / proportion} imgInfo={v.imgInfo} cropOption={v.cropInfo} className="item-img" src={v.filePath}/>
                                </View>
                ...
                <Upload onChange={onChange} fileList={userImageList}>
