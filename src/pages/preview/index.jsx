                            ...
                            return (
                                <SwiperItem className="preview-item" key={v.id}>
                                    <View className="preview-image-wrap">
                                        ...
                                        <LazyImage className="preview-image" src={`${v.url}?imageMogr2/auto-orient/format/jpg/thumbnail/!540x540r/quality/80!/interlace/1/ignore-error/1`} width={640} mode = "aspectFit"/>
